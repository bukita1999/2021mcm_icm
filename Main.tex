...
\begin{figure}[H]
  ...
  \label{SeaT2017} %% label for first subfigure
  
  \includegraphics[width=1.5in]{./picture/1_5.png}}
  
  \hspace{1in}
  
  \subfigure[In 2070]{
  
  \label{SeaT2070} %% label for second subfigure
  
  \includegraphics[width=1.5in]{./picture/1_6.png}}
  
  \caption{The Sea Temperature Map around Scotland in Different Years}
  
  \label{SeaT} %% label for entire figure
...
\begin{figure}[H]
  ...
  \includegraphics[width=3.5cm]{./picture/1_10.png}}
  \hspace{0in}
  \subfigure[After 20 years]{
  \includegraphics[width=3.5cm]{./picture/1_11.png}}
  \hspace{0in}
  \subfigure[After 30 years]{
  \includegraphics[width=3.7cm]{./picture/1_12.png}}
  \hspace{0in}
  \subfigure[After 40 years]{
  \includegraphics[width=3.5cm]{./picture/1_13.png}}
  \hspace{0in}
  \subfigure[After 50 years]{
  \includegraphics[width=3.5cm]{./picture/1_14.png}}
  \label{Dist}
